viewModels.ie_jz_zyzgztzdb = {
  id:"8f7af879-edb8-4e6b-a8f7-db49b92bfcc9",
  name:"ie_jz_zyzgztzdb",
  dataName:"ie_jz_zyzgztzdb",
  colModel:[
    ...
    {name:"zyzt", label:"执业状态", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"zyzt", label:"执业状态", editable:true,nullable:true, hidden:false, dispunitType:"text", },
