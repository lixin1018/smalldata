viewModels.ie_jz_kcsjcyrycdjszdb = {
  id:"95d30459-6c72-4360-a322-e8263e83ea26",
  name:"ie_jz_kcsjcyrycdjszdb",
  dataName:"ie_jz_kcsjcyrycdjszdb",
  colModel:[
    ...
    {name:"jsfl", label:"角色分类", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"jsfl", label:"角色分类", editable:true,nullable:true, hidden:false, dispunitType:"text", },
