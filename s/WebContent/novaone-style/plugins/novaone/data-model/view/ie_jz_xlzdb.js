viewModels.ie_jz_xlzdb = {
  id:"4755027f-ad98-449d-a2c6-41471a91b56b",
  name:"ie_jz_xlzdb",
  dataName:"ie_jz_xlzdb",
  colModel:[
    ...
    {name:"xl", label:"学历", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"xl", label:"学历", editable:true,nullable:true, hidden:false, dispunitType:"text", },
