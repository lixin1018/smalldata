viewModels.sys_InputHelp = {
  id:"102",
  name:"sys_InputHelp",
  dataName:"sys_InputHelp",
  colModel:[
    ...
    {name:"description", label:"描述", width:400, hidden:false, sortable:true, search:false, resizable:true, editable:true, canEdit:true, nullable:false, edittype:"text", dispunitType:"text"}
  ],
  dispUnitModel:[
