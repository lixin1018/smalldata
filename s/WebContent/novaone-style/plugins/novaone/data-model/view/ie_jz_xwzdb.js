viewModels.ie_jz_xwzdb = {
  id:"6c628fdf-575c-4d1b-b4be-d25ef1c5a4b7",
  name:"ie_jz_xwzdb",
  dataName:"ie_jz_xwzdb",
  colModel:[
    ...
    {name:"xwbh", label:"学位编号", width:100, hidden:false, sortable:false, search:false, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"xw", label:"学位", width:200, hidden:false, sortable:false, search:false, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"xwbh", label:"学位编号", editable:true,nullable:true, hidden:false, dispunitType:"text", },
