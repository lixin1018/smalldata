viewModels.ie_jz_qydjzclxzdb = {
  id:"7898a7e4-2661-417d-8a7a-a712f2a46ae1",
  name:"ie_jz_qydjzclxzdb",
  dataName:"ie_jz_qydjzclxzdb",
  colModel:[
    ...
    {name:"qydjzclx", label:"企业登记注册类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
