viewModels.ie_jz_ryzslxzdb = {
  id:"0147b4b0-2794-4007-976e-8e3f74f23a7b",
  name:"ie_jz_ryzslxzdb",
  dataName:"ie_jz_ryzslxzdb",
  colModel:[
    ...
    {name:"zjlx", label:"证件类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"zjlx", label:"证件类型", editable:true,nullable:true, hidden:false, dispunitType:"text", },
