viewModels.ie_jz_qybglxzdb = {
  id:"4263227f-b953-4a63-97d8-a485d0b5a969",
  name:"ie_jz_qybglxzdb",
  dataName:"ie_jz_qybglxzdb",
  colModel:[
    ...
    {name:"bglx", label:"变更类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"bglx", label:"变更类型", editable:true,nullable:true, hidden:false, dispunitType:"text", },
