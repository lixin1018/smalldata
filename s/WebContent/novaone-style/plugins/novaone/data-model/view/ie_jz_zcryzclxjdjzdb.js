viewModels.ie_jz_zcryzclxjdjzdb = {
  id:"a57e103c-ddb9-4e5e-90ec-a265ad2d58a1",
  name:"ie_jz_zcryzclxjdjzdb",
  dataName:"ie_jz_zcryzclxjdjzdb",
  colModel:[
    ...
    {name:"lxjdj", label:"类型及等级", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"lxjdj", label:"类型及等级", editable:true,nullable:true, hidden:false, dispunitType:"text", },
