viewModels.ie_jz_qyzzdjzdb = {
  id:"ba172c4f-934d-4f8c-98fc-360039f72f84",
  name:"ie_jz_qyzzdjzdb",
  dataName:"ie_jz_qyzzdjzdb",
  colModel:[
    ...
    {name:"dj", label:"等级", width:100, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"zzlx", label:"资质类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"dj", label:"等级", editable:true,nullable:true, hidden:false, dispunitType:"text", },
    {name:"zzlx", label:"资质类型", editable:true,nullable:true, hidden:false, dispunitType:"text", },
