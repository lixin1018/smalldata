viewModels.ie_poi_yy = {
  id:"3fc21113-09a3-4e8a-a506-9bad859fe945",
  name:"ie_poi_yy",
  dataName:"ie_poi_yy",
  colModel:[
    ...
    {name:"title", label:"title", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"province", label:"province", width:100, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    ...
    {name:"addresss", label:"address", width:300, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"phonenumber", label:"phoneNumber", width:100, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"addresss", label:"address", editable:true,nullable:true, hidden:false, dispunitType:"text", },
