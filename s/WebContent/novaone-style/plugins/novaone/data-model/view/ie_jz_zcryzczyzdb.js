viewModels.ie_jz_zcryzczyzdb = {
  id:"0b0e4f90-05f0-4d84-934c-5c19fb8b41ef",
  name:"ie_jz_zcryzczyzdb",
  dataName:"ie_jz_zcryzczyzdb",
  colModel:[
    ...
    {name:"bm", label:"代码", width:100, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"zy", label:"专业", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"zclxjdj", label:"注册类型及等级", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"bm", label:"代码", editable:true,nullable:true, hidden:false, dispunitType:"text", },
    {name:"zy", label:"专业", editable:true,nullable:true, hidden:false, dispunitType:"text", },
    {name:"zclxjdj", label:"注册类型及等级", editable:true,nullable:true, hidden:false, dispunitType:"text", },
