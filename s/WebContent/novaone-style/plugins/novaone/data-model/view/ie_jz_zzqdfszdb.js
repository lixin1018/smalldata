viewModels.ie_jz_zzqdfszdb = {
  id:"8a340aa6-584c-43e2-a1b8-1c88bd7ee0a8",
  name:"ie_jz_zzqdfszdb",
  dataName:"ie_jz_zzqdfszdb",
  colModel:[
    ...
    {name:"zzqdfsmc", label:"资质取得方式名称", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"zzqdfsmc", label:"资质取得方式名称", editable:true,nullable:true, hidden:false, dispunitType:"text", },
