viewModels.ie_jz_zzztzdb = {
  id:"67055dfd-0330-443c-ac8b-2077a81cebd7",
  name:"ie_jz_zzztzdb",
  dataName:"ie_jz_zzztzdb",
  colModel:[
    ...
    {name:"zzzt", label:"资质状态", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"zzzt", label:"资质状态", editable:true,nullable:true, hidden:false, dispunitType:"text", },
