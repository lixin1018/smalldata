viewModels.ie_jz_zcryszqydhylxzdb = {
  id:"bf93e684-cbf6-44e4-9525-749c06d866f7",
  name:"ie_jz_zcryszqydhylxzdb",
  dataName:"ie_jz_zcryszqydhylxzdb",
  colModel:[
    ...
    {name:"hylx", label:"行业类型", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"hylx", label:"行业类型", editable:true,nullable:true, hidden:false, dispunitType:"text", },
