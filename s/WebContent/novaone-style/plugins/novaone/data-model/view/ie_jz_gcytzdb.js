viewModels.ie_jz_gcytzdb = {
  id:"9e3e152d-6ef4-440b-8e41-dc2dcb548cf4",
  name:"ie_jz_gcytzdb",
  dataName:"ie_jz_gcytzdb",
  colModel:[
    ...
    {name:"gcyt", label:"工程用途", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"ytdl", label:"用途大类", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
    {name:"ssxmfl", label:"所属项目分类", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"ytdl", label:"用途大类", editable:true,nullable:true, hidden:false, dispunitType:"text", },
    {name:"ssxmfl", label:"所属项目分类", editable:true,nullable:true, hidden:false, dispunitType:"text", },
