viewModels.ie_jz_jsxzflzdb = {
  id:"0a28f53d-fbfe-4e3a-8542-f6057ba604a5",
  name:"ie_jz_jsxzflzdb",
  dataName:"ie_jz_jsxzflzdb",
  colModel:[
    ...
    {name:"gcxz", label:"工程性质", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"gcxz", label:"工程性质", editable:true,nullable:true, hidden:false, dispunitType:"text", },
