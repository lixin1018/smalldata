viewModels.ie_jz_qyzzzgxlzdb = {
  id:"1b584fca-5172-4e65-a0c7-d2bd4d2d2026",
  name:"ie_jz_qyzzzgxlzdb",
  dataName:"ie_jz_qyzzzgxlzdb",
  colModel:[
    ...
    {name:"xlmc", label:"序列名称", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"xlmc", label:"序列名称", editable:true,nullable:true, hidden:false, dispunitType:"text", },
