viewModels.fl_ReceiveFile = {
  ...
  colModel:[
    ...
    {name:"userid", label:"用户id", width:200, hidden:false, sortable:false, search:true, resizable:true, editable:true, canEdit:false, nullable:false, edittype:"text", dispunitType:"text"},
    ...
    {name:"sendfileid", label:"发送记录id", width:250, hidden:false, sortable:false, search:true, resizable:true, editable:true, canEdit:false, nullable:false, edittype:"text", dispunitType:"text"},
    ...
    {name:"fileids", label:"文件id", width:600, hidden:false, sortable:false, search:true, resizable:true, editable:true, canEdit:false, nullable:false, edittype:"text", dispunitType:"text"}
  ],
  dispUnitModel:[
