viewModels.ie_jz_qyzzzgzsztzdb = {
  id:"44db1a5d-6eb4-440d-986d-20fff057c6cd",
  name:"ie_jz_qyzzzgzsztzdb",
  dataName:"ie_jz_qyzzzgzsztzdb",
  colModel:[
    ...
    {name:"zzzszt", label:"资质证书状态", width:200, hidden:false, sortable:true, search:true, resizable:true, editable:true, canEdit:true, nullable:true, edittype:"text", dispunitType:"text"},
  ...
  dispUnitModel:[
    ...
    {name:"zzzszt", label:"资质证书状态", editable:true,nullable:true, hidden:false, dispunitType:"text", },
