paramWinModels.queryYearZhanQuDisease = {
  id:23,
  name:"queryYearZhanQuDisease",
  units:{
    diseaseName:{
      id:147,
      name:"diseaseName",
...
{field:"code",valueType:valueType.string,title:"编码",width:0,hidden:true}
    ...
    zhanQuName:{
      ...
      valueType:valueType.string,
      inputHelpType:"list",
      inputHelpName:"crb.baseData.zhanqu",
      decimalNum:"0",
      valueLength:20,
      isMultiValue:false,
      isNullable:false,
      unitType:"list",
      maps:{"zhanQuId":"id","zhanQuName":"name"},
      list:{
        name:"crb.baseData.zhanqu",
        columns:[{field:"id",valueType:valueType.decimal,title:"id",width:0,hidden:true},
{field:"name",valueType:valueType.string,title:"战区",width:100,hidden:false}
        ]
      },
      defaultValue:"北京军区",
    }
