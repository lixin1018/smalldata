...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/ais_InvokeStatusType.js"></script>
	<script type="text/javascript" src="${viewModel}/ais_InvokeStatusType.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.ais_InvokeStatusType,
						onePageRowCount:20,
						isRefreshAfterSave:false,
						viewModel:viewModels.ais_InvokeStatusType 
			};
