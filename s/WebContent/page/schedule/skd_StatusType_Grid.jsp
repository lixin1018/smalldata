...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/skd_StatusType.js"></script>
	<script type="text/javascript" src="${viewModel}/skd_StatusType.js"></script>
	...
	<script> 
		$(document).ready(function(){  
			var p = { 
					...
					multiselect:true,  
					dataModel:dataModels.skd_StatusType,
					onePageRowCount:20,
					isRefreshAfterSave:false,
					viewModel:viewModels.skd_StatusType 
			};
