...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/skd_JobType.js"></script>
	<script type="text/javascript" src="${viewModel}/skd_JobType.js"></script>
	...
	<script> 
		$(document).ready(function(){  
			var p = { 
					...
					multiselect:true,  
					dataModel:dataModels.skd_JobType,
					onePageRowCount:20,
					isRefreshAfterSave:false,
					viewModel:viewModels.skd_JobType 
			};
