...
<head> 
	...
	<script type="text/javascript"> 
		...
		$(document).ready(function(){ 
			...
			var instanceName = decodeURIComponent(queryStrings["name"]);
			var instanceId = queryStrings["instanceid"];  

			$("#instanceNameId").text(instanceName);
			$("#instanceId").text("(instance:" + instanceId + ")");
			
			egl = new ExcelGridInstanceLayout();
			egl.loadFromServer({
			...
			$("#calcInstanceBtnId").click(function(){
				egl.calcOnServer({
					afterCalcFunc:function(){
						window.open("showInstanceResult.jsp?name=" + encodeURIComponent(instanceName) + "&instanceid=" + instanceId, instanceId + "Result"); 
					}
				});
			});			
		});
...
<body class="easyui-layout" style="width:100%;height:100%;" id="testGridContainer">
	...
	<div id="toolbarContainerId" data-options="region:'north',border:false" style="height:56px;overflow:hidden;">	 
		<div class="gridToolbar">  
			<a id="calcInstanceBtnId" href="#" class="easyui-linkbutton" style="float:right;" data-options="plain:true,iconCls:'icon-edit'">计算</a>
