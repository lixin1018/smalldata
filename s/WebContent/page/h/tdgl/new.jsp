	...
	<div id="pageContentDiv" class="pageContent" style="height:490px;width:100%;background-color:#ffffff;text-align:center;">
		<div class="pagePathContainer">			
			<div class="pagePathInner">
				...
				<span class="pathPathNameText">新建团队</span> 
			</div>	 
		</div> 
		<div style="width:1200px;position:relative;height:100%;margin:1px auto;">
			<div style="position:absolute;left:0px;width:170px;top:0x;background-color:#ffffff;">
				<jsp:include  page="../tdgl/subMenu.jsp">
					<jsp:param value="createTeam" name="subMenuName"/>
				</jsp:include>
			</div>
			<div id="innerDiv" style="position:absolute;left:425px;top:0px;bottom:20px;width:450px;background-color:#ffffff;font-family: arial,'Hiragino Sans GB','Microsoft YaHei',sans-serif;">
				...
				<input type="text" placeholder="请输入团队名称"  id="nameInputId" style="position:absolute;left:25px;top:80px;width:270px;height:22px;line-height:22px;padding:10px;display: block;color:#333333;font-size:100%;font-family: arial,'Hiragino Sans GB','Microsoft YaHei',sans-serif;" />
				...
				<div id="alertDescriptionInputId" style="position:absolute;left:340px;top:140px;width:270px;height:22px;line-height:22px;padding:10px;display: block;font-size:12px;font-family: arial,'Hiragino Sans GB','Microsoft YaHei',sans-serif;text-align:left;color: #f56600;"></div>
				 
				<div id="saveNewTeamBtnId" style="position:absolute;left:25px;top:260px;width:294px;height:42px;line-height:42px;padding:0px;display: block;color:#333333;font-size:16px;font-family: arial,'Hiragino Sans GB','Microsoft YaHei',sans-serif;background-color: #f56600;color:#ffffff;cursor:pointer;">提交</div>
			</div>
		</div>
	</div> 
	<div class="sectionBlankSpace"></div>	
