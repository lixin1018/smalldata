	...
	<div id="pageContentDiv" class="pageContent">
		<div id="orderContaienrDiv" class="orderContaienr"> 
			...
			<%
							...
							String payCodeUrl = "";
							try{
								payCodeUrl = buyControl.getWeixinPayCodeUrl(ncpSession, orderId);
							}
							catch(Exception ex){
			...
			<%
							...
							if(payCodeUrl.length() > 0){
								payCodeUrl = CommonFunction.encode(payCodeUrl);
			%>
			<div class="orderSection">
				...
				<div class="payCodeSection">
					<img class="payCodeImg" src="payCode.jsp?codeurl=<%=payCodeUrl%>" />
				</div>
			</div>
			<%
							}
