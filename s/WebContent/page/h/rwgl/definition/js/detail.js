...
function getLinkHtml(versionId, isEnable){
	...
	var editPageUrl = "editDefinition.jsp?excelgrid=" + definitionId + "&version=" + versionId;
	 
	var showEditBtnHtml = "<a target=\"_blank\" href=\"" + editPageUrl + "\" style=\"line-height:24px;cursor:pointer;\">编辑</a>";
...
function showEditPage(versionId){
	...
	var definitionId = excelGridRow.getValue("id");
	var editPageUrl = "editDefinition.jsp?excelgrid=" + definitionId + "&version=" + versionId;
	window.parent.location = editPageUrl;
	return false;
}
