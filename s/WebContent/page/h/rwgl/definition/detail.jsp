			...
			<div data-options="region:'north',border:false">
				<table>
					<tr style="height:22px;">
						...
						<td colspan="4" style="width:810px;height:22px;"><input type="text" name="name" class="easyui-validatebox" style="width:810px;height:22px;" cardCtrl="true"></input></td>
					</tr>
					<tr style="height:22px;">
						<td style="width:100px;height:22px;text-align:right;">描述</td>
						<td colspan="4" style="width:810px;height:22px;"><input type="text" name="description" class="easyui-validatebox" style="width:810px;height:22px;" cardCtrl="true"></input></td>
					</tr>
					<tr style="height:22px;">
						<td style="width:100px;text-align:right;">所属团队</td> 
						<td style="width:300px;height:22px;"><input type="text" name="teamname" style="width:300px;height:22px;" cardCtrl="true"></input></td> 
						<td style="width:100px;height:22px;text-align:right;">创建时间</td>
						<td style="width:300px;height:22px;"><input type="text" name="createtime" style="width:300px;height:22px;" cardCtrl="true"></input></td> 
					</tr> 
				</table>
			</div>
