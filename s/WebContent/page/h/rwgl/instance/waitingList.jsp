...
<head> 
	...
	<style>
		...
		.detailStepCreateTimeDiv{position:absolute;left:500px;top:0px;width:150px;height:30px;line-height:30px;font-size:12px;text-align:center;color:#757575;}
	...
	<div id="pageContentDiv" class="pageContent" style="height:660px;width:100%;background-color:#ffffff;text-align:center;">
		<div class="pagePathContainer">			
			<div class="pagePathInner">
				...
				<span class="pathPathNameText">待办事项</span> 
			</div>	 
		</div> 
		<div style="width:1200px;position:relative;height:100%;margin:1px auto;">
			<div style="position:absolute;left:0px;width:170px;top:0x;background-color:#ffffff;">
				<jsp:include  page="../../rwgl/subMenu.jsp">
					<jsp:param value="waitingList" name="subMenuName"/>
				</jsp:include>
			</div>			
				<%				
					...
					int pageCount = waitingProcessStepCount / onePageItemCount + (waitingProcessStepCount % onePageItemCount > 0 ? 1 : 0); 					
					
					List<DataRow> waitingProcessInstanceSteps = waitingProcessStepCount == 0 ? null : excelGridInstanceControl.getWaitingProcessInstanceSteps(ncpSession, fromIndex, onePageItemCount);
				%>	
			<div id="innerDiv" style="position:absolute;left:200px;top:0px;bottom:50px;width:1000px;background-color:#ffffff;font-family:'Microsoft YaHei','lucida grande', tahoma, verdana, arial, sans-serif;">
				<div style="position:absolute;left:0px;top:0px;bottom:0px;width:100%;height:640px;">	
					<div Style="position:absolute;left:0px;top:0px;right:0px;height:40px;border-bottom:solid 1px #E3E4E5;">
						<div style="position:absolute;left:50px;top:0px;width:150px;height:40px;line-height:45px;font-size:15px;font-weight:600;text-align:left;color:#ff6700;">待办任务</div>
						<div style="position:absolute;left:0px;top:0px;width:50px;height:40px;line-height:40px;font-size:22px;font-weight:600;text-align:center;color:#ff6700;"><%=waitingProcessStepCount%></div>
					</div>			
				<%
				...
				%>
						<div class="detailLineDiv">
							...
							<div class="detailStepTitleDiv">
								<a title="<%=stepTitle%>" href="processStep.jsp?instance=<%=instanceId%>&step=<%=stepId%>" target="_blank"><%=stepTitle%></a>
							</div>
							<div class="detailStepCreateTimeDiv"><%=stepCreateTimeStr%></div>
