...
<head>
	...
	<script type="text/javascript" src="js/bringBack.js"></script>
	...
	<script type="text/javascript" src="js/historyStep.js"></script> 
...
<body class="easyui-layout" style="width:100%;height:100%;" id="bodyContainerId"> 
	<div class="headerTop" style="position:absolute;height:30px;left:0px;right:0px;z-index:4;">
		...
		<div style="position:absolute;top:2px;right:10px;height:26px;float:right;width:400px;">
			...
			<a id="bringBackBtnId" href="#" class="easyui-linkbutton" style="float:right;" data-options="plain:true,iconCls:'icon-end'">取回</a>
		</div>	
	</div> 
	<div class="headerBottom" style="display:none;">
		<div class="headerBottomInner" style="width:100%;">
			<div class="headerLeftBottom" style="width:380px;">
				...
				<span style="position:absolute;left:237px;top:24px;width:140px;height:30px;font-size:16px;font-weight:600;">- 历史经办</span>
	...
	<jsp:include page="bringBack.jsp"></jsp:include>
