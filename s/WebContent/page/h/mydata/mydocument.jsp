...
<head> 
	...
	<link rel="stylesheet" type="text/css" href="css/mydocument.css">  
...
<body>
	<div id="pageHeaderDiv" class="pageHeader">
		<jsp:include page="../home/headerA.jsp">
			<jsp:param value="mydocument" name="menuName"/>
		</jsp:include>
	</div>
	...
	<%				
		...
		if(dirId == null || dirId.length() == 0){
			...
			String myDocumentDirId = dataFileControl.getRootDirId(subNcpSession, RootDirType.myDocument);
			%>
			<input type="hidden" id="rootDirId" value="<%=myDocumentDirId%>" />
			<% 
		}
	%>
	...
	<div id="pageContentDiv" class="pageContent dirPageContent">
		<div class="dirMainContainer">
			...
			<div id="selectDir" class="selectDir">
				...
				<div name="navigateBar" class="selectNavigateBar">
					...
					<div class="selectBtnContainer"> 
						<input name="selectDirBtn" type="button" value="确 定" class="selectSelectBtn" />
					</div>				
				</div>		 
				<div class="selectColumnTitleContainer">
					<div class="popColumnTitleName">名称<span class="selectNameSortDirection" name="nameSortDirection"></span></div>
			...
			<div id="selectFileType" class="selectFileType" >
				<div name="selectTitleBar" class="selectFileTypeTitleBar" >
					<div name="selectTitle" class="selectFileTypeTitle" ></div>
					<div name="selectClose" class="selectFileTypeClose" ><img class="selectFileTypeCloseImage" name="selectCloseImage" src="img/close.png"  /></div>
				</div>
				<div class="selectFileTypeListContainer" > 
					<%
				...
				<div name="navigateBar" class="selectFileTypeOperateContainer" > 
					<div class="selectFileTypeInputNameContainer" > 
						<input class="selectFileTypeInputName" type="text" name="fileNameInput" placeholder="请输入文件名" ></input> 
					</div> 	
					<div class="selectFileTypeBtnContainer" > 
						<input class="selectFileTypeReturnBtn" name="selectFileTypeBtn" type="button" value="确 定"  />
					</div>				
				</div>	
			</div>
		</div>
