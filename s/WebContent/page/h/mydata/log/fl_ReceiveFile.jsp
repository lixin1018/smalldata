...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/fl_SendFile.js"></script>
	<script type="text/javascript" src="${viewModel}/fl_SendFile.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.fl_SendFile,
						onePageRowCount:20,
						isRefreshAfterSave:false,
						viewModel:viewModels.fl_SendFile 
			};
