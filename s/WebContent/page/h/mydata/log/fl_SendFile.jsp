...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/fl_ReceiveFile.js"></script>
	<script type="text/javascript" src="${viewModel}/fl_ReceiveFile.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.fl_ReceiveFile,
						onePageRowCount:20,
						isRefreshAfterSave:false,
						viewModel:viewModels.fl_ReceiveFile 
			};
