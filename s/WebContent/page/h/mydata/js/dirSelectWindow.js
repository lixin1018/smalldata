function DirSelectWindow(){
	...
	this.init = function(p){	
		...
		$("#" + p.contentDivId).find("input[name='selectDirBtn']").click(function(){ 
			that.afterOkFunction({dirId: that.dataDir.id});
			return false;
		}); 
	...
	this.createChildElementHtml = function(dfObj){
		...
		var childElementHtml = "<div class=\"popItemLineDiv\" name=\"itemLine\" did=\"" + dfObj.id + "\">" 
			+ "<div class=\"popItemIconDiv\"><img src=\"img/fileType/" + dfObj.fileType + ".png\" /></div>"
			+ "<div class=\"popItemNameDiv\"><a name=\"nameLink\" title=\"" + nameTitle + "\">" + nameHtml + "</a></div>" 
			+ "<div class=\"popItemFileTypeDiv\">" + fileTypeHtml + "</div>"  
			+ "</div>"; 
