...
<head> 
	...
	$(document).ready(function(){ 
		...
		var triggerType = window.parent.currentNodeTriggerType;
		var docTypeInfo = window.parent.currentDocTypeInfo;
		var needResultType = window.parent.currentNeedResultType;
		var runAt = window.parent.currentRunAt;
		var workflowExpType = window.parent.workflowExpType;
		var expression = initParam.value;

		var inputExpParams = {
			expText:expression, 
			needResultType:needResultType,
			userParameters:docTypeInfo.fields,
			/*
			userParameters:[
