...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/ltsys_user_type.js"></script>
	<script type="text/javascript" src="${viewModel}/ltsys_user_type.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			dataModel:dataModels.ltsys_user_type,
			onePageRowCount:20, 
			viewModel:viewModels.ltsys_user_type 
		};
