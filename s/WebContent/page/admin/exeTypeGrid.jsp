...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${dataModel}/fl_ExeType.js"></script>
		<script type="text/javascript" src="${viewModel}/fl_ExeType.js"></script>
		...
		<script>
			$(document).ready(function() {
				var p = {
					...
					multiselect : true,
					dataModel : dataModels.fl_ExeType,
					onePageRowCount : 20,
					isRefreshAfterSave : true,
					viewModel : viewModels.fl_ExeType
				};
