...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/d_Post.js"></script>
	<script type="text/javascript" src="${viewModel}/d_Post.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.d_Post,
						onePageRowCount:20,
						isRefreshAfterSave:true,
						viewModel:viewModels.d_Post 
			};
...
<body class="easyui-layout" style="width:100%;height:100%;" id = "testGridContainer">
	<div class="ncpGridToolbarContainer" data-options="region:'north',border:false">	 
		...
		<input type="button" id="editUserRoleId" value="分配角色" /> 	
	</div>   
