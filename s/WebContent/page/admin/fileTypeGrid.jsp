...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${dataModel}/fl_FileType.js"></script>
		<script type="text/javascript" src="${viewModel}/fl_FileType.js"></script>
		...
		<script>
			$(document).ready(function() {
				var p = {
					...
					multiselect : true,
					dataModel : dataModels.fl_FileType,
					onePageRowCount : 20,
					isRefreshAfterSave : true,
					viewModel : viewModels.fl_FileType
				};
