	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
				...
				multiselect:true,  
				dataModel:dataModels.grab_TaskInstance,
				onePageRowCount:20,
				isRefreshAfterSave:true,
				viewModel:viewModels.grab_TaskInstance,
				sheetModel:sheetModels.taskInstance,
				detailPageUrl:"grab_TaskInstance_Sheet.jsp"
			};
