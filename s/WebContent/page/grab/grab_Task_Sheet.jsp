			...
			<div data-options="region:'north',border:false" style="overflow:hidden;">
				<table>
					<tr style="height:25px;">
						...
						<td style="width:300px;height:22px;"><input type="text" name="name" style="width:300px;height:22px;" cardCtrl="true"></input></td>
						<td style="width:50px;height:22px;text-align:right;">Data名称</td>
						<td style="width:300px;height:22px;"><input type="text" name="dataname" style="width:300px;height:22px;" cardCtrl="true"></input></td>
					</tr>
					<tr style="height:50px;">
						<td style="text-align:right;">描述</td>
						<td colspan="3"><textarea name="description" style="width:660px;height:50px;" cardCtrl="true"></textarea></td> 
					</tr>
				</table>
			</div>
