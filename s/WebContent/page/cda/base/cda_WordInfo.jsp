...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/cda_WordInfo.js"></script>
	<script type="text/javascript" src="${viewModel}/cda_WordInfo.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.cda_WordInfo,
						onePageRowCount:20,
						isRefreshAfterSave:false,
						viewModel:viewModels.cda_WordInfo 
			};
