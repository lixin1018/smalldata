...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/cda_WordInfoType.js"></script>
	<script type="text/javascript" src="${viewModel}/cda_WordInfoType.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.cda_WordInfoType,
						onePageRowCount:20,
						isRefreshAfterSave:false,
						viewModel:viewModels.cda_WordInfoType 
			};
