...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/cda_WordInfoSpecies.js"></script>
	<script type="text/javascript" src="${viewModel}/cda_WordInfoSpecies.js"></script>
	...
	$(document).ready(function(){ 
		...
		var p = { 
			...
			dataModel:dataModels.cda_WordInfoSpecies,
			onePageRowCount:20, 
			viewModel:viewModels.cda_WordInfoSpecies
		};
