	...
	<script> 
		$(document).ready(function(){  
			var p = { 
					...
					multiselect:true,  
					dataModel:dataModels.test_MyDoc,
					onePageRowCount:20,
					isRefreshAfterSave:true,
					viewModel:viewModels.test_MyDoc, 
					sheetModel:sheetModels.myDoc,
					detailPageUrl:"test_MyDoc_Create_Card.jsp",
					docTypeName:"测试单据",
					windowType:"create"
				};
