...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/wf_QueryInstanceList.js"></script>
	<script type="text/javascript" src="${viewModel}/wf_QueryInstanceList.js"></script> 
	
	<script> 
		$(document).ready(function(){  
			var p = { 
					containerId:"queryInstanceListContainer",   
					docTypeListContainerId:"docTypeListContainer", 
					multiselect:true,  
					dataModel:dataModels.wf_QueryInstanceList,
					viewModel:viewModels.wf_QueryInstanceList,
					onePageRowCount:20,
...
<body style="width:100%;height:100%;">
	<div id = "queryInstanceListContainer" class="easyui-layout" style="width:100%;height:100%;" >
