			...
			<div data-options="region:'north',border:false">
				<table>
					<tr style="height:22px;">
						...
						<td style="width:100px;height:22px;"><input type="checkbox" name="isusing" style="width:100px;height:22px;" cardCtrl="true"></input></td>
						<td style="width:50px;height:22px;text-align:right;">类型</td>
						<td style="width:100px;height:22px;"><input type="text" name="sqltype" style="width:100px;height:22px;" cardCtrl="true"></input></td>
