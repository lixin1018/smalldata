...
<head> 
	...
	<script type="text/javascript" src="../js/ncpEditData.js"></script>
...
<body class="easyui-layout" style="width:100%;height:100%;" id="dataGridContainer">
	<div class="ncpGridToolbarContainer" data-options="region:'north',border:false">	 
		...
		<span class="ncpGridComplexQueryBar"><a name="complexQueryBtn" href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-complexQuery',text:'高级查询'"></a></span>
	</div>   
