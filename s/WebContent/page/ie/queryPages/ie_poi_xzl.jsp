...
<head> 
	...
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,POI_写字楼"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="POI_写字楼"> 
	<script type="text/javascript" src="${dataModel}/ie_poi_xzl.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_poi_xzl.js"></script> 
	
	<script>
		var paramWinModelUnits = {city: {
id: "5d9d3521-5425-43b4-8bab-aa889a3b4327",
name: "city",
label: "city",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_poi_xzl;
		var viewModel = viewModels.ie_poi_xzl;
		var definitionId = "7e0e1721-0c15-474b-a1a5-33eb8994d2d8";
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">POI_写字楼</div>	 
