...
<head> 
	<title>建筑_学历字典表</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,建筑_学历字典表"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="建筑_学历字典表">
	<script type="text/javascript" src="../js/ncpShareDataGrid.js"></script>
	<script type="text/javascript" src="${dataModel}/ie_jz_xlzdb.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_jz_xlzdb.js"></script>
...
id: "6fe75f1b-7e1c-4f99-bd4b-621ffc8f0a5d",
name: "xh",
label: "&#24207;&#21495;",
...
bm: {
id: "4f175e1a-cb68-4309-898d-efe131bdb06b",
name: "bm",
label: "&#32534;&#30721;",
valueType: valueType.string,
inputHelpType: "",
...
xl: {
id: "0142f166-0cdc-4e61-8ea1-91ab3386426c",
name: "xl",
label: "&#23398;&#21382;",
valueType: valueType.string,
inputHelpType: "",
...
isdeleted: {
id: "4755027f-ad98-449d-a2c6-41471a91b56b_1",
name: "isdeleted",
label: "&#24050;&#21024;&#38500;",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_jz_xlzdb;
		var viewModel = viewModels.ie_jz_xlzdb;
		var definitionId = "364f87a7-5b2b-43d7-acc5-ac0c06db4c38";
...
if(result.values.xl.length != 0){
gridWin.sysWhere.push({parttype:"field", field:"xl", title:"&#23398;&#21382;", operator:"like", value: result.values.xl });
}
...
<div class="tableQueryLine"><div class="tableQueryItemName">&#23398;&#21382;:&nbsp;</div></div>
<div class="tableQueryLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="xl" paramCtrl="true"/></div></div>
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">建筑_学历字典表</div>	 
