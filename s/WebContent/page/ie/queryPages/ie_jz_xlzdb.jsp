...
if(result.values.xl != null && result.values.xl.length != 0){
...
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="xl" paramCtrl="true"/></div></div>
