...
<head> 
	<title>POI_金融机构</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,POI_金融机构"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="POI_金融机构"> 
	<script type="text/javascript" src="${dataModel}/ie_poi_jrjg.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_poi_jrjg.js"></script> 
	
	<script>
		var paramWinModelUnits = {city: {
id: "d5f8c9b8-1aad-46f7-b0c1-eab3d68b6efd",
name: "city",
label: "city",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_poi_jrjg;
		var viewModel = viewModels.ie_poi_jrjg;
		var definitionId = "d097788c-9134-4f20-9069-696aa1d5e7af";
		
		function queryData(pageNumber){ 		
			var result = paramWin.getParamResult();			
			if(result.verified){
				gridWin.sysWhere = new Array();  
				if(result.values.city != null && result.values.city.length != 0){
...
<body class="easyui-layout" style="width:100%;height:100%;" id="dataGridContainer"> 
	<div id="queryControlContainerId" class="tableQueryContainer"> 
		...
		<div class="tableQueryNameLine"><div class="tableQueryItemName">city:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="city" paramCtrl="true"/></div></div>
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">POI_金融机构</div>	 
