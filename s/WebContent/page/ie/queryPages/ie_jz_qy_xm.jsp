...
defaultValue: null
		...
		function queryData(pageNumber){ 		
			...
			if(result.verified){
				...
				if(result.values.xmsd != null && result.values.xmsd.length != 0){
...
<body class="easyui-layout" style="width:100%;height:100%;" id="dataGridContainer"> 
	<div id="queryControlContainerId" class="tableQueryContainer"> 
		...
		<div class="tableQueryNameLine"><div class="tableQueryItemName">&#39033;&#30446;&#23646;&#22320;:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="xmsd" paramCtrl="true"/></div></div>
