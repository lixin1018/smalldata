...
<head> 
	<title>建筑_项目分类字典表</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,建筑_项目分类字典表"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="建筑_项目分类字典表"> 
	<script type="text/javascript" src="${dataModel}/ie_jz_xmflzdb.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_jz_xmflzdb.js"></script> 
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">建筑_项目分类字典表</div>	 
