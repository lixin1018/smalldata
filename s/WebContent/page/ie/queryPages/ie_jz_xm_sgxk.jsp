...
defaultValue: null
		...
		function queryData(pageNumber){ 		
			...
			if(result.verified){
				...
				if(result.values.xmbm != null && result.values.xmbm.length != 0){
...
<body class="easyui-layout" style="width:100%;height:100%;" id="dataGridContainer"> 
	<div id="queryControlContainerId" class="tableQueryContainer"> 
		...
		<div class="tableQueryNameLine"><div class="tableQueryItemName">&#39033;&#30446;&#32534;&#30721;:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="xmbm" paramCtrl="true"/></div></div>
