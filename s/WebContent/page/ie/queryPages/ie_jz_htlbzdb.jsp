...
<head> 
	<title>建筑_合同类别字典表</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,建筑_合同类别字典表"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="建筑_合同类别字典表">
	<script type="text/javascript" src="../js/ncpShareDataGrid.js"></script>
	<script type="text/javascript" src="${dataModel}/ie_jz_htlbzdb.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_jz_htlbzdb.js"></script>
...
id: "d2e5792b-5621-46ae-991e-d75eabb7c917",
name: "xh",
label: "&#24207;&#21495;",
...
bm: {
id: "ec9cb8a7-d83d-44bd-821e-f8053215a778",
name: "bm",
label: "&#32534;&#30721;",
valueType: valueType.string,
inputHelpType: "",
...
htlb: {
id: "5d895c6a-7249-4496-b3d4-e3832ce20468",
name: "htlb",
label: "&#21512;&#21516;&#31867;&#21035;",
valueType: valueType.string,
inputHelpType: "",
...
htfl: {
id: "f70c3206-f24f-42df-8c79-556c4a0bcf7a",
name: "htfl",
label: "&#21512;&#21516;&#20998;&#31867;",
valueType: valueType.string,
inputHelpType: "",
...
isdeleted: {
id: "7a9ef713-b4fd-4432-899b-99762a6182a8_1",
name: "isdeleted",
label: "&#24050;&#21024;&#38500;",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_jz_htlbzdb;
		var viewModel = viewModels.ie_jz_htlbzdb;
		var definitionId = "13d25c7b-bbdf-4258-a7f7-78ffd3344e46";
...
if(result.values.htfl.length != 0){
gridWin.sysWhere.push({parttype:"field", field:"htfl", title:"&#21512;&#21516;&#20998;&#31867;", operator:"like", value: result.values.htfl });
}
...
<div class="tableQueryLine"><div class="tableQueryItemName">&#21512;&#21516;&#20998;&#31867;:&nbsp;</div></div>
<div class="tableQueryLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="htfl" paramCtrl="true"/></div></div>
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">建筑_合同类别字典表</div>	 
