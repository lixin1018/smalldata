...
<head> 
	...
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,POI_学校"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="POI_学校"> 
	<script type="text/javascript" src="${dataModel}/ie_poi_xx.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_poi_xx.js"></script> 
	
	<script>
		var paramWinModelUnits = {city: {
id: "7fdf3edb-23bb-4135-b637-34d95f91857c",
name: "city",
label: "city",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_poi_xx;
		var viewModel = viewModels.ie_poi_xx;
		var definitionId = "820c7c4f-11a6-4efe-b544-516609ce414f";
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">POI_学校</div>	 
