...
<head> 
	...
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,国标_行政区划"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="国标_行政区划">
	<script type="text/javascript" src="../js/ncpShareDataGrid.js"></script>
	<script type="text/javascript" src="${dataModel}/ie_gb_xzqh.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_gb_xzqh.js"></script>
...
id: "efc6f34e-18ee-4cb0-ab3d-fc976eee63b2",
name: "dm",
label: "&#20195;&#30721;",
...
mc: {
id: "52a93e97-0038-4357-bb0f-2c710c065e2b",
name: "mc",
label: "&#21517;&#31216;",
valueType: valueType.string,
inputHelpType: "",
...
isdeleted: {
id: "5623939d-66c3-44fc-823c-9f2efa003104_1",
name: "isdeleted",
label: "&#24050;&#21024;&#38500;",
...
defaultValue: null
		...
		var dataModel = dataModels.ie_gb_xzqh;
		var viewModel = viewModels.ie_gb_xzqh;
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">国标_行政区划</div>	 
