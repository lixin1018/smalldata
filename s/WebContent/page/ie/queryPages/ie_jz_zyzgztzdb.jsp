...
<head> 
	<title>建筑_执业资格状态字典表</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">
	<meta http-equiv="keywords" content="数据助手,数据共享,数据工具,数据,数据抓取,建筑_执业资格状态字典表"> 
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />	
	<meta http-equiv="description" content="建筑_执业资格状态字典表"> 
	<script type="text/javascript" src="${dataModel}/ie_jz_zyzgztzdb.js"></script>
	<script type="text/javascript" src="${viewModel}/ie_jz_zyzgztzdb.js"></script> 
	
	<script>
		var paramWinModelUnits = {xh: {
id: "c9f0785b-e3e3-4f37-a538-0f9d76e51b7c",
name: "xh",
label: "&#24207;&#21495;",
...
bm: {
id: "327eb7fc-2d28-4253-b821-ff2b66f7e300",
name: "bm",
label: "&#32534;&#30721;",
valueType: valueType.string,
decimalNum: 0,
...
zyzt: {
id: "76fd2e9a-7113-437c-b069-fc5269117349",
name: "zyzt",
label: "&#25191;&#19994;&#29366;&#24577;",
valueType: valueType.string,
decimalNum: 0,
...
defaultValue: null
		...
		var dataModel = dataModels.ie_jz_zyzgztzdb;
		var viewModel = viewModels.ie_jz_zyzgztzdb;
		var definitionId = "5e1864bc-3a66-45f8-aff7-df3fffefc7fe";
...
if(result.values.zyzt != null && result.values.zyzt.length != 0){
gridWin.sysWhere.push({parttype:"field", field:"zyzt", title:"&#25191;&#19994;&#29366;&#24577;", operator:"like", value: result.values.zyzt });
}
...
<div class="tableQueryNameLine"><div class="tableQueryItemName">&#25191;&#19994;&#29366;&#24577;:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="zyzt" paramCtrl="true"/></div></div>
	...
	<div class="headerMain" data-options="region:'north',border:false">  
		...
		<div class="tableHeader">
			<div class="tableHeaderInner">  
				<div class="tableTitle">建筑_执业资格状态字典表</div>	 
