...
defaultValue: null
		...
		function queryData(pageNumber){ 		
			...
			if(result.verified){
				...
				if(result.values.xm != null && result.values.xm.length != 0){
...
<body class="easyui-layout" style="width:100%;height:100%;" id="dataGridContainer"> 
	<div id="queryControlContainerId" class="tableQueryContainer"> 
		...
		<div class="tableQueryNameLine"><div class="tableQueryItemName">&#22995;&#21517;:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="xm" paramCtrl="true"/></div></div>
