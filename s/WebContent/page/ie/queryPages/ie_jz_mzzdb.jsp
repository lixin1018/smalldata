...
if(result.values.mz != null && result.values.mz.length != 0){
...
<div class="tableQueryNameLine"><div class="tableQueryItemName">&#27665;&#26063;:&nbsp;</div></div>
<div class="tableQueryValueLine"><div class="tableQueryItemInputContainer"><input class="tableQueryItemInput" type="text" name="mz" paramCtrl="true"/></div></div>
