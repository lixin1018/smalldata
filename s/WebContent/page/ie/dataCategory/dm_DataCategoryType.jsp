...
<head> 
	...
	<script type="text/javascript" src="${dataModel}/dm_DataCategoryType.js"></script>
	<script type="text/javascript" src="${viewModel}/dm_DataCategoryType.js"></script>
	...
	<script> 
		$(document).ready(function(){ 
			var p = { 
						...
						multiselect:true,  
						dataModel:dataModels.dm_DataCategoryType,
						onePageRowCount:20,
						isRefreshAfterSave:true,
						viewModel:viewModels.dm_DataCategoryType
			};
