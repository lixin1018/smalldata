...
public class CheckIsHistoryStepProcessUser implements Filter {
    @Override  
    public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2) throws IOException, ServletException {  
        ...
        if(instanceId == null || instanceId.length() == 0 || stepId == null || stepId.length() == 0){
	        ...
	        try{
	        	...
	        	DataRow stepRow = excelGridInstanceProcessor.getInstanceStep(instanceId, stepId);
	        	String processUserId = stepRow.getStringValue("processuserid");
