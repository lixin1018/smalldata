...
public class DbDataProcessor extends FileBaseProcessor{
	...
	class MyThread extends Thread{
		...
		public void run(){
			...
			DbDataProcessor.endThreadCount++;
		}
	...
	public void matchedPerson(INcpSession session) throws Exception {
		try{
			...
			String deleteSql = "delete from ie_user_umassd_name2pilot";
			...
			DbDataProcessor.threadCount = nameListPageCount;
			while(DbDataProcessor.threadCount != DbDataProcessor.endThreadCount){
				Thread.sleep(3000);
			}
	...
	private List<DataRow> getNameListRows() throws SQLException{
		Session dbSession = this.getDBSession();
		String nameListSql = "select n.id as id, n.co_per_rol as co_per_rol, n.first_name as first_name, n.middle_name as middle_name, n.last_name as last_name from ie_user_umassd_name_list n";
