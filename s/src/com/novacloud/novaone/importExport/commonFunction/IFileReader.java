...
public interface IFileReader {
	...
	void checkValueLength(List<String[]> allMemoRows, HashMap<String, String> itemName2DbName, HashMap<String, Integer> dbFieldNameToLength, HashMap<String, DataType> dbFieldNameToType) throws Exception;
